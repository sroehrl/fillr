...
(function(context, document, undefined){
    ...
    function final(){
        ...
        for(let i = 0;i<matchingElements.snapshotLength;i++){
            ...
            matchingElements.snapshotItem(i).innerText.replace(/{{lorem}}/g,(match)=>{
                matchingElements.snapshotItem(i).innerText = matchingElements.snapshotItem(i).innerText.replace('{{lorem}}',getLoremText(estimate))
            });
        }
    }
